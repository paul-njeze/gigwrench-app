...
export const T: Record<Language, Record<string, string>> = {
  en: {
    dashboard: 'Dashboard', jobs: 'Jobs', invoices: 'Invoices', customers: 'Customers',
  ...
  es: {
    dashboard: 'Panel', jobs: 'Trabajos', invoices: 'Facturas', customers: 'Clientes',
    ...
    loading: 'Cargando...', error: 'Algo salió mal', success: 'Listo',
  },
  pt: {
    dashboard: 'Painel', jobs: 'Trabalhos', invoices: 'Faturas', customers: 'Clientes',
    ...
    loading: 'Carregando...', error: 'Algo deu errado', success: 'Pronto',
  },
  fr: {
    dashboard: 'Tableau de bord', jobs: 'Travaux', invoices: 'Factures', customers: 'Clients',
    ...
    loading: 'Chargement...', error: "Quelque chose s'est mal passé", success: 'Fait',
  },
  pl: { dashboard: 'Panel', jobs: 'Prace', invoices: 'Faktury', customers: 'Klienci', messages: 'Wiadomości', settings: 'Ustawienia', logout: 'Wyloguj', add_job: 'Dodaj pracę', new_invoice: 'Nowa faktura', send_invoice: 'Wyślij fakturę', on_my_way: 'Jadę', job_complete: 'Oznacz jako ukończone', get_paid: 'Pobierz płatność', scheduled: 'Zaplanowane', in_progress: 'W toku', completed: 'Ukończone', paid: 'Zapłacone', earnings_today: 'Zarobki dziś', jobs_this_week: 'Prace w tym tygodniu', outstanding: 'Oczekujące', avg_rating: 'Średnia ocena', welcome_back: 'Witaj z powrotem', good_morning: 'Dzień dobry', good_afternoon: 'Dzień dobry', good_evening: 'Dobry wieczór', no_jobs_today: 'Brak zaplanowanych prac na dziś', next_job: 'Następna praca', customer: 'Klient', address: 'Adres', amount: 'Kwota', save: 'Zapisz', cancel: 'Anuluj', delete: 'Usuń', edit: 'Edytuj', search: 'Szukaj', loading: 'Ładowanie...', error: 'Coś poszło nie tak', success: 'Gotowe' },
  tl: { dashboard: 'Dashboard', jobs: 'Mga Trabaho', invoices: 'Mga Invoice', customers: 'Mga Kliyente', messages: 'Mga Mensahe', settings: 'Mga Setting', logout: 'Mag-sign out', add_job: 'Magdagdag ng trabaho', new_invoice: 'Bagong invoice', send_invoice: 'Ipadala ang invoice', on_my_way: 'Papunta na ako', job_complete: 'Markahan bilang tapos', get_paid: 'Bayad', scheduled: 'Nakatakda', in_progress: 'Ginagawa', completed: 'Tapos na', paid: 'Bayad na', earnings_today: 'Kita ngayon', jobs_this_week: 'Mga trabaho ngayong linggo', outstanding: 'Hindi pa bayad', avg_rating: 'Average na rating', welcome_back: 'Maligayang pagbabalik', good_morning: 'Magandang umaga', good_afternoon: 'Magandang hapon', good_evening: 'Magandang gabi', no_jobs_today: 'Walang nakatakdang trabaho ngayon', next_job: 'Susunod na trabaho', customer: 'Kliyente', address: 'Address', amount: 'Halaga', save: 'I-save', cancel: 'Kanselahin', delete: 'Burahin', edit: 'I-edit', search: 'Maghanap', loading: 'Naglo-load...', error: 'May nangyaring mali', success: 'Tapos' },
  ar: { dashboard: 'لوحة التحكم', jobs: 'الأعمال', invoices: 'الفواتير', customers: 'العملاء', messages: 'الرسائل', settings: 'الإعدادات', logout: 'تسجيل الخروج', add_job: 'إضافة عمل', new_invoice: 'فاتورة جديدة', send_invoice: 'إرسال الفاتورة', on_my_way: 'في طريقي', job_complete: 'تحديد كمكتمل', get_paid: 'استلام الدفع', scheduled: 'مجدول', in_progress: 'قيد التنفيذ', completed: 'مكتمل', paid: 'مدفوع', earnings_today: 'أرباح اليوم', jobs_this_week: 'أعمال هذا الأسبوع', outstanding: 'معلق', avg_rating: 'متوسط التقييم', welcome_back: 'مرحباً بعودتك', good_morning: 'صباح الخير', good_afternoon: 'مساء الخير', good_evening: 'مساء الخير', no_jobs_today: 'لا أعمال مجدولة اليوم', next_job: 'العمل التالي', customer: 'عميل', address: 'عنوان', amount: 'المبلغ', save: 'حفظ', cancel: 'إلغاء', delete: 'حذف', edit: 'تعديل', search: 'بحث', loading: 'جار التحميل...', error: 'حدث خطأ ما', success: 'تم' },
  ru: { dashboard: 'Панель', jobs: 'Работы', invoices: 'Счета', customers: 'Клиенты', messages: 'Сообщения', settings: 'Настройки', logout: 'Выйти', add_job: 'Добавить работу', new_invoice: 'Новый счёт', send_invoice: 'Отправить счёт', on_my_way: 'Еду к вам', job_complete: 'Отметить выполненной', get_paid: 'Получить оплату', scheduled: 'Запланировано', in_progress: 'В процессе', completed: 'Выполнено', paid: 'Оплачено', earnings_today: 'Доход сегодня', jobs_this_week: 'Работы на этой неделе', outstanding: 'Ожидает оплаты', avg_rating: 'Средний рейтинг', welcome_back: 'С возвращением', good_morning: 'Доброе утро', good_afternoon: 'Добрый день', good_evening: 'Добрый вечер', no_jobs_today: 'Нет запланированных работ на сегодня', next_job: 'Следующая работа', customer: 'Клиент', address: 'Адрес', amount: 'Сумма', save: 'Сохранить', cancel: 'Отмена', delete: 'Удалить', edit: 'Изменить', search: 'Поиск', loading: 'Загрузка...', error: 'Что-то пошло не так', success: 'Готово' },
  zh: { dashboard: '仪表板', jobs: '工作', invoices: '发票', customers: '客户', messages: '消息', settings: '设置', logout: '退出', add_job: '添加工作', new_invoice: '新发票', send_invoice: '发送发票', on_my_way: '我在路上', job_complete: '标记完成', get_paid: '收款', scheduled: '已安排', in_progress: '进行中', completed: '已完成', paid: '已付款', earnings_today: '今日收入', jobs_this_week: '本周工作', outstanding: '未付', avg_rating: '平均评分', welcome_back: '欢迎回来', good_morning: '早上好', good_afternoon: '下午好', good_evening: '晚上好', no_jobs_today: '今天没有安排工作', next_job: '下一个工作', customer: '客户', address: '地址', amount: '金额', save: '保存', cancel: '取消', delete: '删除', edit: '编辑', search: '搜索', loading: '加载中...', error: '出了点问题', success: '完成' },
  hi: { dashboard: 'डैशबोर्ड', jobs: 'काम', invoices: 'बिल', customers: 'ग्राहक', messages: 'संदेश', settings: 'सेटिंग्स', logout: 'लॉग आउट', add_job: 'काम जोड़ें', new_invoice: 'नया बिल', send_invoice: 'बिल भेजें', on_my_way: 'मैं आ रहा हूं', job_complete: 'पूर्ण करें', get_paid: 'भुगतान लें', scheduled: 'निर्धारित', in_progress: 'जारी', completed: 'पूर्ण', paid: 'भुगतान', earnings_today: 'आज की कमाई', jobs_this_week: 'इस सप्ताह के काम', outstanding: 'बकाया', avg_rating: 'औसत रेटिंग', welcome_back: 'वापस स्वागत है', good_morning: 'सुप्रभात', good_afternoon: 'नमस्ते', good_evening: 'शुभ संध्या', no_jobs_today: 'आज कोई काम निर्धारित नहीं', next_job: 'अगला काम', customer: 'ग्राहक', address: 'पता', amount: 'राशि', save: 'सहेजें', cancel: 'रद्द करें', delete: 'हटाएं', edit: 'संपादित करें', search: 'खोजें', loading: 'लोड हो रहा है...', error: 'कुछ गलत हुआ', success: 'हो गया' },
}
