  ...
  return (
    ...
    <div className="relative z-10 min-h-screen flex flex-col">
      <nav className="flex items-center justify-between px-8 py-4 border-b border-white/5">
        ...
        <div className="flex gap-0.5 p-1.5 rounded-xl bg-[#07090D]/60 backdrop-blur-md border border-white/12 shadow-lg">
          {LANGS.map(l => (
            <button key={l.code} onClick={() => setLang(l.code)}
              className={`px-2.5 py-1.5 rounded-lg text-xs font-mono transition-all ${lang === l.code ? 'bg-yellow-400 text-black font-bold' : 'text-white/80 hover:text-white hover:bg-white/10'}`}
      ...
      <div className="flex-1 flex items-center justify-center lg:justify-start px-4 lg:px-16 py-12">
        <div className="w-full max-w-md bg-[#07090D]/72 backdrop-blur-xl border border-white/10 rounded-2xl p-6 sm:p-8 shadow-2xl">
          <div className="mb-8">
