...
const UI: Record<Lang, {
  ...
  ar: {
    heading: 'Check your email in Arabic.',
    sent: 'We sent a verification link to (ar)',
    next_label: 'What to do next (ar)',
    steps: [
      'Open your inbox (ar)',
      'Find the GigWrench email (ar)',
      'Click confirm email (ar)',
      'You will be signed in (ar)',
    ],
    loading: 'Sending...', resend: 'Resend email (ar)',
    resent: 'Verification email resent (ar)',
    wrong: 'Wrong email? (ar)', back: 'Go back (ar)',
    expires: 'Link expires in 24 hours (ar).',
  },
  zh: {
    heading: 'Check your email in Chinese.',
    sent: 'We sent a verification link to (zh)',
    next_label: 'What to do next (zh)',
    steps: [
      'Open your inbox (zh)',
      'Find the GigWrench email (zh)',
      'Click confirm email (zh)',
      'You will be signed in (zh)',
    ],
    loading: 'Sending...', resend: 'Resend email (zh)',
    resent: 'Verification email resent (zh)',
    wrong: 'Wrong email? (zh)', back: 'Go back (zh)',
    expires: 'Link expires in 24 hours (zh).',
  },
  hi: {
    heading: 'Check your email in Hindi.',
    sent: 'We sent a verification link to (hi)',
    next_label: 'What to do next (hi)',
    steps: [
      'Open your inbox (hi)',
      'Find the GigWrench email (hi)',
      'Click confirm email (hi)',
      'You will be signed in (hi)',
    ],
    loading: 'Sending...', resend: 'Resend email (hi)',
    resent: 'Verification email resent (hi)',
    wrong: 'Wrong email? (hi)', back: 'Go back (hi)',
    expires: 'Link expires in 24 hours (hi).',
  },
  ko: {
    heading: 'Check your email in Korean.',
    sent: 'We sent a verification link to (ko)',
    next_label: 'What to do next (ko)',
    steps: [
      'Open your inbox (ko)',
      'Find the GigWrench email (ko)',
      'Click confirm email (ko)',
      'You will be signed in (ko)',
    ],
    loading: 'Sending...', resend: 'Resend email (ko)',
    resent: 'Verification email resent (ko)',
    wrong: 'Wrong email? (ko)', back: 'Go back (ko)',
    expires: 'Link expires in 24 hours (ko).',
  },
  tr: {
