...
const UI: Record<Lang, {
    ...
    ar: {
          ...
          wrong: 'البريد خاطئ؟', back: 'العودة والمحاولة مجددا',
    ...
    zh: {
          ...
          resent: '验证邮件已重新发送',
          wrong: '邮箱填错了？', back: '返回重试',
          expires: '此验证链接将在24小时后过期。',
    },
    hi: {
          ...
          steps: [
                  ...
                  '"अपना ईमेल पुष्टि करें" बटन पर क्लिक करें',
                  'आप स्वचालित रूप से लॉग इन हो जाएंगे',
                ],
    ...
    ko: {
          ...
          expires: '이 인증 링크는 24시간 후에 만료됩니다.',
    },
    tr: {
    ...
    de: {
          ...
          next_label: 'Was als nächstes zu tun ist',
          steps: [
          ...
          wrong: 'Falsche E-Mail?', back: 'Zurück und erneut versuchen',
          expires: 'Dieser Verifikationslink läuft in 24 Stunden ab.',
    },
    it: {
    ...
    sv: {
          ...
          sent: 'Vi skickade en verifieringslänk till',
          next_label: 'Vad du ska göra härnäst',
          steps: [
                  'Öppna din e-postinkorg',
                  'Hitta e-postmeddelandet från GigWrench',
                  'Klicka på "Bekräfta din e-post"',
                  'Du loggas in automatiskt',
                ],
          loading: 'Skickar...', resend: 'Fick du det inte? Skicka om',
          resent: 'Verifieringsmail skickat igen',
          wrong: 'Fel e-post?', back: 'Gå tillbaka och försök igen',
          expires: 'Den här verifieringslänken upphör att gälla om 24 timmar.',
    },
}
        ...
        <div className="min-h-screen bg-[#07090D] flex flex-col">
              <nav className="flex items-center justify-between px-8 py-4 border-b border-white/5">
                      <Link href="/" className="flex items-center gap-2 no-underline">
                                ...
                                <span className="font-display text-xl tracking-widest text-white">GIG<span className="text-yellow-400">WRENCH</span>span></span>span>
                      </Link>Link>
              </nav>nav>
              ...
              <div className="flex-1 flex items-center justify-center px-4 py-16">
                      <div className="w-full max-w-md text-center">
                                ...
                                <h1 className="font-display text-4xl tracking-wider text-white mb-3">{ui.heading}</h1>h1>
                                <p className="text-white/50 text-sm font-mono leading-relaxed mb-2">{ui.sent}</p>p>
                        {email && (
                      <p className="text-yellow-400 font-mono text-sm font-medium mb-6 bg-yellow-400/8 border border-yellow-400/20 rounded-lg px-4 py-2 inline-block">
                        {email}
                                ...
                                <div className="bg-[#0B0F17] border border-white/6 rounded-xl p-6 mb-6 text-left">
                                            <p className="font-mono text-[10px] uppercase tracking-widest text-white/30 mb-4">{ui.next_label}</p>p>
                          ...
                          <div key={i} className="flex items-center gap-3">
                                            <div className="w-6 h-6 rounded-full bg-yellow-400/10 border border-yellow-400/20 flex items-center justify-center flex-shrink-0">
                                                                <span className="font-display text-sm text-yellow-400">{i + 1}</span>span>
                                            </div>div>
                                            <span className="text-white/60 text-sm">{step}</span>span>
                          </div>div>
                        ))}
                                            </div>div>
                                </div>div>
                      ...
                      <div className="flex items-center gap-2 justify-center text-green-400 font-mono text-xs">
                        ...
                        {ui.resent}
                                ...
                                <div className="mt-8 pt-6 border-t border-white/6">
                                            ...
                                            <p className="text-white/10 font-mono text-[10px] mt-3">{ui.expires}</p>p>
                                </div>div>
                      </div>div>
              </div>div>
        </div>div>
