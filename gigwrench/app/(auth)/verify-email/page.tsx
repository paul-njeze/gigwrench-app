...
const UI: Record<Lang, {
  ...
  ar: {
    ...
    loading: 'Sending...', resend: 'لم تستلمه؟ اعادة الارسال',
  ...
  zh: {
    ...
    loading: 'Sending...', resend: '没有收到？重新发送邮件',
    resent: '验证邮件已重新发送',
  ...
  hi: {
    ...
    loading: 'Sending...', resend: 'नहीं मिला? ईमेल फिर से भेजें',
  ...
  ko: {
    ...
    loading: 'Sending...', resend: '받지 못하셨나요? 이메일 재전송',
