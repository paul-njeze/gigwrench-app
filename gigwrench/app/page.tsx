...
const COPY: Record<string, Record<string, string>> = {
  ...
  es: {
    ...
    pick_sub: "GigWrench está disponible en 14 idiomas para Pros y clientes de todo el mundo.",
    skip: "Continuar en inglés",
    nav_signin: "Iniciar sesión",
    nav_cta: "Empieza gratis",
    hero_h1_a: "Maneja tu oficio",
    hero_h1_b: "como un Pro.",
    hero_sub: "GigWrench da a los Pros independientes las herramientas de IA para ganar más trabajos, cobrar más rápido y nunca perder un cliente. Todo por $19 al mes.",
    hero_cta1: "Empieza gratis",
    hero_cta2: "Ver cómo funciona",
    problem_label: "El problema",
    problem_h2: "Ser autónomo en los oficios es duro.",
    problem_body: "Contestas llamadas mientras trabajas. Cobras tarde. Pierdes clientes cuando estás ocupado. Facturas a mano. GigWrench lo resuelve todo.",
    feat_label: "Funciones",
    feat_h2: "Todo lo que un Pro necesita.",
    compare_label: "Comparación",
    compare_h2: "Por qué los Pros eligen GigWrench.",
    faq_label: "FAQ",
    ...
    app_sub: "Las apps nativas para Android e iOS están en camino. Regístrate en la web ahora.",
    app_android: "Próximamente en Google Play",
    app_ios: "Próximamente en App Store",
    app_beta: "Únete a la beta en la web",
    ...
    stat_lead: "Respuesta a leads",
    stat_flat: "Tarifa fija, sin comisiones",
    stat_langs: "Idiomas",
    stat_id: "Pros verificados",
    stat_pros: "Pros independientes en EEUU",
  ...
  pt: {
    ...
    pick_sub: "GigWrench está disponível em 14 idiomas para Pros e clientes no mundo todo.",
    skip: "Continuar em inglês",
    nav_signin: "Entrar",
    nav_cta: "Comece grátis",
    hero_h1_a: "Gere seu negócio",
    hero_h1_b: "como um Pro.",
    hero_sub: "GigWrench dá aos Pros autônomos ferramentas de IA para ganhar mais trabalhos, receber mais rápido e nunca perder um cliente. Tudo por $19 por mês.",
    hero_cta1: "Comece grátis",
    hero_cta2: "Veja como funciona",
    problem_label: "O problema",
    problem_h2: "Trabalhar por conta própria é difícil.",
    problem_body: "Você atende ligações enquanto trabalha. Persegue pagamentos. Perde clientes quando está ocupado. GigWrench resolve tudo isso.",
    feat_label: "Recursos",
    ...
    app_h2: "Leve o GigWrench com você.",
    app_sub: "Apps nativos para Android e iOS estão chegando. Cadastre-se na web agora.",
    ...
    beta_pill: "Beta já disponível",
    stat_lead: "Resposta a leads",
    stat_flat: "Taxa fixa, sem comissões",
    stat_langs: "Idiomas",
    stat_id: "Pros verificados",
    stat_pros: "Pros autônomos nos EUA",
    table_feature: "Recurso",
    coming_soon: "Em breve",
    footer_signup: "Cadastrar",
    footer_terms: "Termos",
  ...
  fr: {
    ...
    hero_h1_a: "Gérez votre métier",
    hero_h1_b: "comme un Pro.",
    hero_sub: "GigWrench donne aux Pros indépendants les outils IA pour gagner plus de chantiers, être payés plus vite et ne jamais rater un client. Tout pour 19$ par mois.",
    hero_cta1: "Commencer gratuitement",
    hero_cta2: "Voir comment ça marche",
    problem_label: "Le problème",
    problem_h2: "Travailler à son compte, c'est dur.",
    problem_body: "Vous répondez aux appels pendant vos chantiers. Vous relancez les clients pour être payé. Vous perdez des leads parce que vous êtes occupé. GigWrench règle tout ça.",
    ...
    app_sub: "Les apps natives Android et iOS arrivent bientôt. Inscrivez-vous sur le web maintenant.",
    app_android: "Bientôt sur Google Play",
    app_ios: "Bientôt sur App Store",
    app_beta: "Rejoindre la beta sur le web",
    footer_tagline: "Fait pour les Pros. Alimenté par IA.",
    footer_copy: "2026 GigWrench. Tous droits réservés.",
    beta_pill: "Beta disponible",
    stat_lead: "Réponse aux leads",
    stat_flat: "Tarif fixe, sans frais",
    stat_langs: "Langues",
    stat_id: "Pros vérifiés",
    stat_pros: "Pros solo aux USA",
...
const FEATURE_TEXT: Record<string, { title: string; desc: string }[]> = {
  ...
  pt: [
    { title: "Reservas com IA Dispatch", desc: "Responde a novos leads em menos de 90 segundos enquanto você trabalha. Nenhum concorrente faz isso." },
    { title: "GigWrench Lens", desc: "Aponte a câmera para qualquer peça. Receba identificação instantânea, alternativas de fornecedores e adicione a uma fatura. Exclusivo do GigWrench." },
    { title: "Rastreamento GPS ao vivo", desc: "Os clientes veem exatamente onde você está e quando vai chegar. Acaba com as ligações de “já vem?”." },
    ...
    { title: "CRM de clientes", desc: "Cada cliente, cada trabalho, cada nota em um só lugar. Saiba quem te deve dinheiro e quem é cliente recorrente." },
    { title: "Motor de fidelidade", desc: "Entra em contato automaticamente com clientes antigos com dicas, acompanhamentos e lembretes de agendamento. Mantém sua agenda cheia sem esforço." },
    { title: "14 idiomas", desc: "A única plataforma do setor construída para uma força de trabalho multilíngue. Disponível em inglês, espanhol, português, francês, árabe, chinês, hindi, coreano, turco, alemão, italiano, holandês, romeno e sueco." },
    { title: "Painel de análises", desc: "Tendências de receita, estatísticas de trabalhos, detalhamento de clientes. Saiba exatamente como seu negócio está indo num relance." },
  ],
  fr: [
    { title: "Réservation IA Dispatch", desc: "Répond aux nouveaux leads en moins de 90 secondes pendant que vous travaillez. Aucun concurrent ne fait cela." },
    { title: "GigWrench Lens", desc: "Pointez votre caméra sur n'importe quelle pièce. Obtenez une identification instantanée, des alternatives de fournisseurs et ajoutez-la à une facture. Unique à GigWrench." },
    { title: "Suivi GPS en direct", desc: "Les clients voient exactement où vous êtes et quand vous arriverez. Fini les appels “vous arrivez?”." },
    { title: "Facturation intelligente", desc: "Créez des factures professionnelles et envoyez un lien de paiement Stripe en moins d'une minute. Fini de courir après les paiements." },
    { title: "CRM clients", desc: "Chaque client, chaque chantier, chaque note au même endroit. Sachez qui vous doit de l'argent et qui est un client fidèle." },
    { title: "Moteur de fidélité", desc: "Recontacte automatiquement vos anciens clients avec des conseils, des suivis et des rappels de réservation. Garde votre agenda plein sans effort." },
    { title: "14 langues", desc: "La seule plateforme du secteur conçue pour une main-d'oeuvre multilingue. Disponible en anglais, espagnol, portugais, français, arabe, chinois, hindi, coréen, turc, allemand, italien, néerlandais, roumain et suédois." },
    { title: "Tableau de bord analytique", desc: "Tendances de revenus, statistiques de chantiers, répartition des clients. Sachez exactement comment va votre activité en un coup d'oeil." },
  ],
  es: [
    { title: "Reservas con IA Dispatch", desc: "Responde a nuevos leads en menos de 90 segundos mientras trabajas. Ningún competidor hace esto." },
    { title: "GigWrench Lens", desc: "Apunta tu cámara a cualquier pieza. Obtén identificación al instante, alternativas de proveedores y agrégala a una factura. Único de GigWrench." },
    { title: "Rastreo GPS en vivo", desc: "Los clientes ven exactamente dónde estás y cuándo vas a llegar. Elimina las llamadas de “¿ya vienes?”." },
    { title: "Facturación inteligente", desc: "Crea facturas profesionales y envía un enlace de pago de Stripe en menos de un minuto. Se acabó perseguir pagos." },
    { title: "CRM de clientes", desc: "Cada cliente, cada trabajo, cada nota en un solo lugar. Sabe quién te debe dinero y quién es cliente frecuente." },
    { title: "Motor de fidelidad", desc: "Contacta automáticamente a clientes anteriores con consejos, seguimientos y recordatorios de reserva. Mantén tu calendario lleno sin esfuerzo." },
    { title: "14 idiomas", desc: "La única plataforma del sector construida para una fuerza laboral multilingüe. Disponible en inglés, español, portugués, francés, árabe, chino, hindi, coreano, turco, alemán, italiano, neerlandés, rumano y sueco." },
    { title: "Panel de analíticas", desc: "Tendencias de ingresos, estadísticas de trabajos, desglose de clientes. Sabe exactamente cómo va tu negocio de un vistazo." },
  ],
}
...
const COMPARE_ROWS: Record<string, CompareRow[]> = {
  ...
  pt: [
    { feature: "Preço mensal", gw: "$19 fixo", thumb: "$300-500", angi: "$300+", hcp: "$149+" },
    ...
    { feature: "Identificação de peças IA", gw: true, thumb: false, angi: false, hcp: false },
    ...
    { feature: "Verificação de identidade", gw: true, thumb: false, angi: false, hcp: false },
    { feature: "Sequências de fidelidade", gw: true, thumb: false, angi: false, hcp: false },
    { feature: "Taxa de instalação", gw: "Nenhum", thumb: "Nenhum", angi: "Nenhum", hcp: "Nenhum" },
  ],
  fr: [
    ...
    { feature: "Agent de réservation IA", gw: true, thumb: false, angi: false, hcp: false },
    { feature: "Identification de pièces IA", gw: true, thumb: false, angi: false, hcp: false },
    { feature: "Suivi GPS en direct", gw: true, thumb: false, angi: false, hcp: "Option" },
    { feature: "Facturation intégrée", gw: true, thumb: false, angi: false, hcp: true },
    { feature: "14 langues", gw: true, thumb: false, angi: false, hcp: false },
    { feature: "Vérification d'identité", gw: true, thumb: false, angi: false, hcp: false },
    { feature: "Séquences de fidélité", gw: true, thumb: false, angi: false, hcp: false },
  ...
  es: [
    ...
    { feature: "Agente de reservas IA", gw: true, thumb: false, angi: false, hcp: false },
    { feature: "Identificación de piezas IA", gw: true, thumb: false, angi: false, hcp: false },
    { feature: "Rastreo GPS en vivo", gw: true, thumb: false, angi: false, hcp: "Complemento" },
    { feature: "Facturación integrada", gw: true, thumb: false, angi: false, hcp: true },
    { feature: "14 idiomas", gw: true, thumb: false, angi: false, hcp: false },
    { feature: "Verificación de identidad", gw: true, thumb: false, angi: false, hcp: false },
    { feature: "Secuencias de fidelidad", gw: true, thumb: false, angi: false, hcp: false },
    { feature: "Costo de instalación", gw: "Ninguno", thumb: "Ninguno", angi: "Ninguno", hcp: "Ninguno" },
  ],
}
...
const FAQ_PROS: Record<string, Faq[]> = {
  ...
  pt: [
    { q: "Quanto custa o GigWrench?", a: "$19 por mês, fixo. Sem taxas por lead, sem comissões, sem cobranças ocultas. Cancele quando quiser." },
    { q: "Como o Dispatch funciona quando estou trabalhando?", a: "Quando um cliente manda mensagem ou preenche sua página de agendamento, o Dispatch responde em menos de 90 segundos, coleta os dados, pergunta sobre o problema e avisa você. Você nunca perde um lead, mesmo de mãos ocupadas." },
    { q: "Preciso ser especialista em tecnologia para usar o GigWrench?", a: "Não. Se você sabe enviar uma mensagem de texto, sabe usar o GigWrench. A interface foi feita para Pros, não para engenheiros de software." },
    { q: "O GigWrench fica com parte dos meus ganhos?", a: "Nunca. Seus ganhos são seus. Cobramos uma taxa mensal fixa. O Stripe processa os pagamentos direto para a sua conta." },
    { q: "O que é o GigWrench Lens?", a: "O Lens usa a câmera do seu celular e IA para identificar qualquer peça na hora. Mostra o que é a peça, onde encontrá-la e permite adicioná-la a uma fatura com um toque. Nenhuma outra plataforma oferece isso." },
    { q: "Em quais idiomas o GigWrench está disponível?", a: "Inglês, espanhol, português, francês, árabe, chinês, hindi, coreano, turco, alemão, italiano, holandês, romeno e sueco. O app completo e as páginas de agendamento funcionam nos 14 idiomas." },
  ],
  fr: [
    { q: "Combien coûte GigWrench?", a: "19$ par mois, forfait fixe. Pas de frais par lead, pas de commissions, pas de frais cachés. Annulez quand vous voulez." },
    { q: "Comment Dispatch fonctionne quand je suis sur un chantier?", a: "Quand un client envoie un message ou remplit votre page de réservation, Dispatch répond en moins de 90 secondes, recueille ses informations, pose des questions sur le problème et vous prévient. Vous ne ratez jamais un lead, même les mains prises." },
    { q: "Faut-il être un expert en technologie pour utiliser GigWrench?", a: "Non. Si vous savez envoyer un SMS, vous savez utiliser GigWrench. L'interface est conçue pour les Pros, pas pour les ingénieurs." },
    { q: "GigWrench prend-il une part de mes revenus?", a: "Jamais. Vos revenus sont à vous. Nous facturons un forfait mensuel fixe. Stripe traite les paiements directement sur votre compte." },
    { q: "Qu'est-ce que GigWrench Lens?", a: "Lens utilise la caméra de votre téléphone et l'IA pour identifier toute pièce instantanément. Il vous montre la pièce, où la trouver, et vous permet de l'ajouter à une facture en un geste. Aucune autre plateforme ne propose cela." },
    { q: "Dans quelles langues GigWrench est-il disponible?", a: "Anglais, espagnol, portugais, français, arabe, chinois, hindi, coréen, turc, allemand, italien, néerlandais, roumain et suédois. L'application complète et les pages de réservation fonctionnent dans les 14 langues." },
  ],
  es: [
    { q: "¿Cuánto cuesta GigWrench?", a: "$19 al mes, tarifa fija. Sin costos por lead, sin comisiones, sin cargos ocultos. Cancela cuando quieras." },
    { q: "¿Cómo funciona Dispatch cuando estoy trabajando?", a: "Cuando un cliente te escribe o llena tu página de reservas, Dispatch responde en menos de 90 segundos, recoge sus datos, pregunta por el problema y te avisa. Nunca pierdes un lead aunque tengas las manos ocupadas." },
    { q: "¿Necesito ser experto en tecnología para usar GigWrench?", a: "No. Si sabes enviar un mensaje de texto, sabes usar GigWrench. La interfaz está hecha para Pros, no para ingenieros de software." },
    ...
    { q: "¿Qué es GigWrench Lens?", a: "Lens usa la cámara de tu teléfono e IA para identificar cualquier pieza al instante. Te muestra qué es la pieza, dónde conseguirla y te permite agregarla a una factura con un toque. Ninguna otra plataforma ofrece esto." },
    { q: "¿En qué idiomas está disponible GigWrench?", a: "Inglés, español, portugués, francés, árabe, chino, hindi, coreano, turco, alemán, italiano, neerlandés, rumano y sueco. La app completa y las páginas de reserva funcionan en los 14 idiomas." },
  ],
}
...
const FAQ_CUSTOMERS: Record<string, Faq[]> = {
  ...
  pt: [
    { q: "Como encontro e agendo um Pro?", a: "Acesse app.gigwrench.app e use Encontrar um Pro para ver Pros verificados perto de você. Você também pode agendar direto pelo link pessoal de agendamento de um Pro." },
    { q: "Os Pros no GigWrench são verificados?", a: "Sim. Os Pros passam por verificação de identidade com documento oficial e checagem de vivacidade por selfie antes de aparecer na lista. Você vê o selo de verificação no perfil." },
    { q: "Vou saber quando meu Pro estiver a caminho?", a: "Sim. Quando um Pro ativa o rastreamento GPS a caminho de você, você recebe um link ao vivo com a localização e o horário estimado de chegada." },
    { q: "Meu pagamento é seguro?", a: "Sim. Todos os pagamentos passam pelo Stripe, a mesma infraestrutura usada por Amazon, Google e Shopify. O GigWrench nunca guarda os dados do seu cartão." },
    { q: "E se eu precisar cancelar ou remarcar?", a: "Fale direto com seu Pro pela confirmação do agendamento. As políticas de cancelamento são definidas por cada Pro." },
  ],
  fr: [
    { q: "Comment trouver et réserver un Pro?", a: "Allez sur app.gigwrench.app et utilisez Trouver un Pro pour parcourir les Pros vérifiés près de chez vous. Vous pouvez aussi réserver directement via le lien de réservation personnel d'un Pro." },
    { q: "Les Pros sur GigWrench sont-ils vérifiés?", a: "Oui. Les Pros passent une vérification d'identité avec pièce officielle et un contrôle de présence par selfie avant d'être listés. Vous voyez leur badge de vérification sur leur profil." },
    { q: "Saurai-je quand mon Pro est en route?", a: "Oui. Dès qu'un Pro active le suivi GPS en venant chez vous, vous recevez un lien en direct montrant sa position et l'heure d'arrivée estimée." },
    { q: "Mon paiement est-il sécurisé?", a: "Oui. Tous les paiements passent par Stripe, la même infrastructure que celle utilisée par Amazon, Google et Shopify. GigWrench ne stocke jamais les détails de votre carte." },
    { q: "Et si je dois annuler ou reprogrammer?", a: "Contactez votre Pro directement via la confirmation de réservation. Les politiques d'annulation sont définies par chaque Pro." },
  ],
  es: [
    { q: "¿Cómo encuentro y reservo un Pro?", a: "Entra a app.gigwrench.app y usa Buscar un Pro para ver Pros verificados cerca de ti. También puedes reservar directamente con el enlace de reservas de un Pro." },
    { q: "¿Los Pros en GigWrench están verificados?", a: "Sí. Los Pros pasan por verificación de identidad con documento oficial y prueba de vida con selfie antes de aparecer en la lista. Puedes ver su insignia de verificación en su perfil." },
    { q: "¿Sabré cuándo mi Pro va en camino?", a: "Sí. Cuando un Pro activa el rastreo GPS de camino a ti, recibes un enlace en vivo que muestra su ubicación y la hora estimada de llegada." },
    { q: "¿Es seguro mi pago?", a: "Sí. Todos los pagos se procesan a través de Stripe, la misma infraestructura de pagos que usan Amazon, Google y Shopify. GigWrench nunca guarda los datos de tu tarjeta." },
    { q: "¿Qué pasa si necesito cancelar o reprogramar?", a: "Contacta a tu Pro directamente desde la confirmación de la reserva. Cada Pro define sus propias políticas de cancelación." },
  ],
}
