...
export default function ForgotPasswordPage() {
  ...
  // NIST IA-5: Password reset — verified via email link
  // NIST AC-7: Does not reveal whether email exists (security)
  async function handleReset(e: React.FormEvent) {
    e.preventDefault()
    setLoading(true)
    setError('')
    const supabase = createClient()
    // Always show success — prevents email enumeration (NIST AC-7)
