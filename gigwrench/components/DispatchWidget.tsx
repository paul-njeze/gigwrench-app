...
const UI: Record<string, Record<string, string>> = {
  ...
  ar: { online: 'Dispatch متصل', pick: 'اختر لغتك', greeting: 'مرحبا! انا Dispatch، منسق GigWrench. كيف يمكنني مساعدتك اليوم؟', placeholder: 'اكتب رسالتك...', send: 'ارسال', escalate_prompt: 'للتواصل مع فريقنا، هل يمكنني الحصول على اسمك وبريدك الالكتروني؟', name_ph: 'اسمك', email_ph: 'بريدك الالكتروني', submit: 'ارسال للدعم', escalate_done: 'تم. سيتابع فريقنا معك عبر البريد الالكتروني في غضون ساعات. هل هناك اي شيء اخر يمكنني مساعدتك به؟', powered: 'مدعوم من GigWrench', change_lang: 'تغيير اللغة' },
  zh: { online: 'Dispatch 在线', pick: '请选择您的语言', greeting: '你好！我是 Dispatch，您的 GigWrench 协调员。今天有什么可以帮助您的？', placeholder: '输入您的消息...', send: '发送', escalate_prompt: '为了将您与我们的团队联系，能否告诉我您的姓名和电子邮件？', name_ph: '您的姓名', email_ph: '您的电子邮件', submit: '发送到支持团队', escalate_done: '好的。我们的团队将在几小时内通过电子邮件跟进。还有其他可以帮助您的吗？', powered: 'GigWrench 提供支持', change_lang: '更改语言' },
  hi: { online: 'Dispatch ऑनलाइन है', pick: 'अपनी भाषा चुनें', greeting: 'नमस्ते! मैं Dispatch हूं, आपका GigWrench समन्वयक। आज मैं आपकी कैसे मदद कर सकता हूं?', placeholder: 'अपना संदेश लिखें...', send: 'भेजें', escalate_prompt: 'आपको हमारी टीम से जोड़ने के लिए, क्या आप अपना नाम और ईमेल दे सकते हैं?', name_ph: 'आपका नाम', email_ph: 'आपका ईमेल पता', submit: 'सपोर्ट को भेजें', escalate_done: 'हो गया। हमारी टीम कुछ घंटों में आपके ईमेल पर संपर्क करेगी। क्या और कुछ मदद कर सकता हूं?', powered: 'GigWrench द्वारा संचालित', change_lang: 'भाषा बदलें' },
  ko: { online: 'Dispatch 온라인', pick: '언어를 선택하세요', greeting: '안녕하세요! 저는 Dispatch, GigWrench 코디네이터입니다. 오늘 어떻게 도와드릴까요?', placeholder: '메시지를 입력하세요...', send: '보내기', escalate_prompt: '팀에 연결해 드리기 위해 성함과 이메일을 알려주시겠어요?', name_ph: '이름', email_ph: '이메일 주소', submit: '지원팀으로 보내기', escalate_done: '완료됩니다. 팀이 몇 시간 내에 이메일로 연락 드리겠습니다. 더 도움이 필요하신가요?', powered: 'GigWrench 제공', change_lang: '언어 변경' },
  tr: { online: 'Dispatch çevrimiçi', pick: 'Dilinizi seçin', greeting: 'Merhaba! Ben Dispatch, GigWrench koordinatörünüz. Bugün size nasıl yardımcı olabilirim?', placeholder: 'Mesajınızı yazın...', send: 'Gönder', escalate_prompt: 'Sizi ekibimizle buluşturmak için adınızı ve e-postanızı alabilir miyim?', name_ph: 'Adınız', email_ph: 'E-posta adresiniz', submit: 'Desteğe gönder', escalate_done: 'Tamam. Ekibimiz birkaç saat içinde e-postanızda takip edecek. Başka yardımcı olabileceğim bir şey var mı?', powered: 'GigWrench tarafından desteklenir', change_lang: 'Dili değiştir' },
  ...
  ro: { online: 'Dispatch este online', pick: 'Alegeți limba', greeting: 'Bună! Sunt Dispatch, coordonatorul tău GigWrench. Cum te pot ajuta astăzi?', placeholder: 'Scrie mesajul tău...', send: 'Trimite', escalate_prompt: 'Pentru a te conecta cu echipa noastră, îmi poți da numele și emailul?', name_ph: 'Numele tău', email_ph: 'Adresa ta de email', submit: 'Trimite la suport', escalate_done: 'Gata. Echipa noastră va reveni la emailul tău în câteva ore. Te pot ajuta cu altceva?', powered: 'Oferit de GigWrench', change_lang: 'Schimbă limba' },
